 ...
 *    C source code generated on : 06-May-2020 10:59:15
 *
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        (void) memcpy(&__u1BUS[0].Ai1, u1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(&__u1BUS[0].Ai2, u1 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__u1BUS[0].Ai3, u1 +  __dtBusInfo[14],  __dtBusInfo[15]);
        (void) memcpy(&__u1BUS[0].Ai4, u1 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__u1BUS[0].Di1, u1 +  __dtBusInfo[18],  __dtBusInfo[19]);
        (void) memcpy(&__u1BUS[0].Di2, u1 +  __dtBusInfo[20],  __dtBusInfo[21]);
        (void) memcpy(&__u1BUS[0].Di3, u1 +  __dtBusInfo[22],  __dtBusInfo[23]);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    {
        uint32_T chk[] = {823275921, 3897179595, 1623919122, 1415836226};
        int_T status;
